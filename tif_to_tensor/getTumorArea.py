...
def getArgs():
    ...
    parser = argparse.ArgumentParser(
        description="Determine the area of a tumor from an annotated image file.")
    parser.add_argument(
        "-d", "--directory", help="(optional) path to directory of images to be filtered. default is current directory.", type=str)
    parser.add_argument(
        "-f", '--format', help="(optional) image file extension, default png", type=str, default="png")
    parser.add_argument("-o", '--output', help="(optional) filename to write results summary, default=getTumorArea_results.txt",
                        type=str, default="getTumorArea_results.txt")
