...
def get_arguments():
    parser = argparse.ArgumentParser(
        description="Keras InceptionV3 architecture for tumor image \
        classification"
    )
    # Multi-GPU
    parser.add_argument(
    ...
    parser.add_argument(
        "-c", "--class_weights", help="modify class weight penalization, \
        higher value increases bias toward tumor class",
...
if(args.graphical_history):
    ...
    plt.legend()
    plt.savefig(args.output_directory + "/" + args.output_name +
